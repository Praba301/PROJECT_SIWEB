              ...
              <div className="flex-1 w-full flex flex-col gap-1.5 relative">
                <div className="relative">
                  ...
                  <input
                    ...
                    className={`w-full bg-[#0A0A12] border rounded-xl pl-12 pr-4 py-3.5 text-white text-sm placeholder:text-[#6B6B80] focus:outline-none focus:ring-1 transition-all duration-300 uppercase ${
                      errorResi 
